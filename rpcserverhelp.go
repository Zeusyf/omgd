...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, OMCD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in OMC as the value",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in OMC/KB",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in OMC/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in OMC/KB",
	...
	"gettxoutresult-value":         "The transaction amount in OMC",
